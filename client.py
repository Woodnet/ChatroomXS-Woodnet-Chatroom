...
entry_field = tkinter.Entry(top, width=24,font="Arial 23",textvariable=my_msg)
entry_field.bind("<Return>", send)
entry_field.pack()
send_button = tkinter.Button(top,font="Arial 16",bg="white", fg="green",text="Send", command=send)
send_button.pack()
